        ...
        this.state = {
            ...
            work: [
                {
                    ...
                    workDetail : [
                        {head: 'PC 웹페이지 서비스 개발', content: ['입사 후 개발 시작 단계 : PC 웹사이트에 서비스를 도입하는 초기 단계 (모바일앱 서비스만 존재)', '기획에 따라 웹페이지 기능 개선 및 구축 (HTML 마크업 및 퍼블리싱, RESTful API 연결 등 기능 구현)', '깃랩(GitLab)으로 이슈 관리 (기획, 마케팅 등과 협의 시에는 트렐로(Trello)로 관리)']},
                        {head: '앱 내의 웹페이지 서비스 개발', content: ['개발팀 협의로 앱 내에 웹페이지 개발이 필요한 부분은 웹 포지션으로 개발 (개발 변경이 잦은 서비스 페이지 등)']},
                    ],
                ...
                },
                {
                    ...
                    workDetail : [
                        {head: '웹사이트와 모바일웹 구축을 위한 디자인 및 퍼블리싱 작업', content: ['입사 후 개발 시작 단계 : 서버 세팅만 되어있는 상태에서 처음부터 개발을 시작하는 단계', '웹 작업 비율(%) = 웹 디자인 작업 70% + 퍼블리싱 30%']},
                    ],
            ...
            qna : [
                ...
                // },
                {
                    ...
                    answer: `일은 사회에서 '나'의 가치를 실현할 수 있는 좋은 도구라고 생각합니다.<br/>저는 늙어서 죽기 전까지 일을 계속하고 싶습니다. 사회의 구성원으로서 저의 몫을 해낼 때의 가치가 저에게 큰 활력을 불어 넣어줍니다. 그래서 제가 잘 할 수 있는, 재미있는, 좋은 서비스를 가진, 발전 가능성이 있는 일을 하고 싶습니다.<br/>생산적인 일을 할 때, 느끼는 보람과 성취감이 저를 더 단단하고 가치 있는 사람으로 여기게 합니다. 일을 통해서 제 자신이 성장하는 것을 추구합니다.`
                },
                // {
                ...
                },
                {
                    ...
                    answer: `웹 퍼블리셔로 웹을 다루기 시작하다가 디자인 작업보다 프론트단 개발하는 것이 더 흥미가 생겼습니다. 그 당시에 웹 디자인, HTML 마크업, CSS까지는 완전히 저의 담당이었고, JS 동적인 부분은 데이터 연결 전까지 할 수 있는 작업을 모두 해서 넘기는 식이었습니다. 그러다가 자바스크립트 영역을 더 많이, 잘 다루고 싶어졌고, 개발 관련하여 여러 스터디(프론트 백엔드 스터디 등)를 다니다가 좋은 인연을 만나서 스타트업 개발팀에서 프론트엔드 개발자로 일을 하게 되었습니다`
                },
                // {
                //     question : '희망연봉이 있나요?',
                ...
                // },
                {
                    ...
                    answer: `자연과 운동을 좋아합니다.<br/>좋아하는 것을 나열하면 초록, 자연, 공원, 클라이밍 등이 있습니다.<br/>운동은 예전에 수영과 자전거 타기를 했었는데, 3년 전부터는 계속 클라이밍만 했습니다.<br/>클라이밍은 나이가 들어서도 꾸준히 할 수 있는 운동이라서 매력적인 운동이라 생각되어 접하게 되었습니다.`, link:[{href:'https://www.instagram.com/soheegreen', title:'instagram'}]
                },
            ]
        }
    }
