...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            infoLink : [
                ...
                {type: 'insta', link: 'https://www.instagram.com/soheegreen', desc: '인스타그램', display: 'off'},
            ...
            <br/><br/>스타트업에 들어오면서 기존에 다뤘던 제이쿼리는 모두 자바스크립트로 교체하였습니다. 그리고 처음에는 무조건 동작이 되게끔 하는 것이 목표였지만(그만큼 못했기 때문에) 나중에는 실행되는 것을 넘어서 최적화하는 작업에 집중할 수 있게 되었습니다. 그렇게 개발 단계를 거치면서 잘 짜인 코드의 중요성과 필요성을 몸소 깨닫게 되었습니다.
            ...
            SideProject : [
                {
                    ...
                    linkList: [
                        ...
                        {title: '사이드프로젝트 서비스 웹사이트', link: 'https://onlyliving.github.io/Side-Projects/dist/'},
                    ],
    ...
    render() {
        ...
        return (
            <div>
                <header>
                    <h1 className="header-top-name">김소희<span className="header-top-name__sub">Web Front-end Developer</span></h1>
                </header>
                
                <main>
                    <article className="content-box content-box--info">
                        <h2 className="hide-text">개인정보</h2>
                        <ul className="info-list">
                            <li className="info-list__email"><a href="mailto:greensohee88@naver.com" target="_blank" rel="noopener noreferrer">greensohee88@naver.com</a></li>
                            <li className="info-list__github"><a href="https://github.com/onlyliving/Side-Projects" target="_blank" rel="noopener noreferrer">https://github.com/onlyliving</a></li>
                            <li className="info-list__notion"><a href="https://www.notion.so/14ef995b935e471abc9b3ab5be30196e" target="_blank" rel="noopener noreferrer">개발 블로그</a></li>
                            {/* <li className="info-list__insta"><a href="https://www.instagram.com/soheegreen" target="_blank" rel="noopener noreferrer">인스타그램</a></li> */}
                            {/* <li className="info-list__tistory"><a href="http://green-webdesigner.tistory.com/" target="_blank" rel="noopener noreferrer">티스토리</a></li> */}
                        </ul>
                    </article>
                    ...
                    <article className="content-box content-box--skills">
                        ...
                        <div className="list-note">
                            <span className="list-note__head">스킬 활용도 기준</span>
                            <ul className="list-note__list">
                                <li>4 - 대규모 프로그램 및 시스템을 참고사항(책/인터넷)없이 개발할 수 있으며, 일반적이지 않은 난해한 부분도 일부 참고를 통해 개발할 수 있음 </li>
                                <li>3 - 중간규모 프로그램 및 시스템을 개발할수 있으며, 주요 이슈 트러블슈팅을 할 수 있을 정도로 내부구조에 대해 이해하고 있음</li>
                                <li>2 - 시스템 동작 방식을 알고 있으며, 기본적인 기능을 구현할 수 있음</li>
                                <li>1 - 코드를 읽을 수 있으며, 책을 참고하여 약간의 수정작업 또는 작은 변경사항 추가를 할 수 있음</li>
                                <li>0 - 경험/지식 없음</li>
                            </ul>
                        </div>
                    </article>
                                ...
                                <ul>
                                    ...
                                    <li className="side-project-list__link-box">
                                        ...
                                        <ul className="link-list">
                                            ...
                                            <li><a href="https://onlyliving.github.io/Side-Projects/dist/" target="_blank" rel="noopener noreferrer">사이드프로젝트 서비스 웹사이트</a></li>
                                        </ul>
                                    </li>
                    ...
                    <article className="content-box content-box-qna">
                        ...
                        <dl className="table-box">
                            ...
                            <dd className="table-box__a" value="a-1">
                                ...
                                <br/>일은 제 삶의 중요한 원동력이기 때문에 더 잘하려고 노력하고, 같이 성장하려고 합니다.
                            </dd>
