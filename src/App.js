        ...
        this.state = {
            ...
            work: [
                ...
                },
                {
                    ...
                    effect: "연구 개발한 AI 엔진에 대하여 학습 결과를 잘 보여줄 수 있는 데모 페이지가 필요해서 투입이 되었습니다. 기획안을 받으면 디자인부터 프론트 개발, 필요한 데이터 구조를 생각해서 플라스크(flask)로 더미 API를 만들었습니다. 그 이후에 팀원이 더미 API를 실제 엔진과 연결하여 완료하는 방식의 흐름으로 진행 되었습니다. 이때 가상환경, PyCharm, Flask 등 Python 개발 환경을 경험하였습니다.",
                },
                {
                    company: "(주)휴마트컴퍼니",
                    position: "개발팀 - 프론트엔드 개발자",
                    ...
                    workDetail: [
                        {
                            ...
                            content: [
                                ...
                                "기존 코드의 경우, 코드 확장성을 위하여(다른 최신 프레임워크를 사용하려면 JS 기반이어야 하므로) PHP, jQuery로 개발된 코드를 HTML, JavaScript 코드로 변경.",
            ...
            <div>
                ...
                <main className="container">
                    ...
                    <section className="contents-wrap">
                        ...
                        <p className="copyright">ⓒ SoheeKim Frontend Resume</p>
                    </section>
                </main>
            </div>
        );
