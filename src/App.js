    ...
    constructor(props) {
        ...
        this.state = {
            ...
            profile: [
                {
                    title: "어쩌다 개발자?",
                    content:
                        "(strong)let 김소희 = 조경설계 + 웹디자이너 + 웹퍼블리싱 + 웹 프론트엔드 개발;(@)저는 자신 있는 것 하나(item)를 교집합 삼아 여기까지 왔습니다.(@)조경설계에서 웹퍼블리셔로 직군을 변경할 때는 '디자인'이 자신 있어서 할 수 있었고, 웹퍼블리셔에서 웹 프론트엔드 개발로 갈 때에는 '웹 퍼블리싱'을 기반으로 발전할 수 있게 되었습니다.",
                },
                {
                    ...
                    workDetail: [
                        {
                            ...
                            content: [
                                "이미지만 업로드하면 쇼핑몰 상세페이지를 자동으로 업로드하는 기능에 필요한 데모페이지를 만들었습니다. 이미지와 캔버스(canvas)를 많이 다뤘습니다.",
                            ],
                        },
                        {
                        ...
                        },
                        {
                            ...
                            content: [
                                "이미지를 업로드해서 필요한 정보를 입력하고 검수 관리할 수 있는 페이지를 만들었습니다.",
                            ],
                        },
                    ],
                ...
                },
                {
                    ...
                    workDetail: [
                        ...
                        },
                        {
                            ...
                            content: [
                                "개발팀 협의로 앱 내에 웹페이지 개발이 필요한 부분은 웹 포지션으로 개발 (개발 변경이 잦은 서비스 페이지 등)",
                            ],
                        },
                    ],
                    ...
                    workDetail: [
                        {
                            ...
                            content: [
                                "입사 후 개발 시작 단계 : 서버 세팅만 되어있는 상태에서 처음부터 개발을 시작하는 단계",
            ...
            qna: [
                ...
                {
                    question:
                        "웹 개발에서 버그 이슈가 생겼을 경우 어떻게 대처하나요?",
                ...
                {
                    question:
                        "조경설계에서 IT업종(웹 개발)으로 넘어오게 된 계기가 무엇인가요?",
