                    ...
                    <section className="contents-wrap">
                        <article id="profileEl" className="content-box content-box--profile is-5-lines-only">
                            ...
                            <div className="content-box__profile-txt">
                                <span className="txt-sub-title">어쩌다 개발자?</span><br/>
                                let 김소희 = 조경설계 + 웹디자이너 + 웹퍼블리싱 + 웹 프론트엔드 개발;<br/><br/>
                                저는 제가 자신 있는 것 하나(item)를 교집합 삼아 여기까지 왔습니다.<br/>
                                조경설계에서 웹퍼블리셔로 직군을 변경할 때는 '디자인'이 자신 있어서 할 수 있었고, 웹퍼블리셔에서 웹 프론트엔드 개발로 갈 때에는 '웹 퍼블리싱'을 기반으로 발전할 수 있게 되었습니다.
                                <br/><br/>
                                <span className="txt-sub-title">웹 프론트엔드 개발자로서의 만족도는?</span><br/>
                                기획과 디자인 의도대로 구현하는 것이 재미있습니다. 그리고 기획단에서 생각하지 못한 디테일을 체크해서, 같이 의견을 맞대어 더 나은 결과물로 발전될 때 더욱 보람을 느낍니다. 노력하는 만큼, 코드와 성과물로 고스란히 보이기 때문에 더욱 잘 해내고 싶습니다.
                            </div>
                        ...
                        <article className="content-box content-box--experience">
                            ...
                            <ul className="experience-list">
                                <li>
                                    ...
                                    <ul>
                                        <li className="experience-list__date">2018.6 ~ 2019.12, 1년 7개월</li>
                                        ...
                                        <li className="experience-list__txt experience-box">
                                            ...
                                            <ul>
                                                <li>- 입사 후 개발 시작 단계 : PC 웹사이트에 서비스를 도입하는 초기 단계 (모바일앱 서비스만 존재)</li>
                                                <li>- 기획에 따라 웹페이지 기능 개선 및 구축 (HTML 마크업 및 퍼블리싱, RESTful API 연결 등 기능 구현)</li>
                                                <li>- 깃랩(GitLab)으로 이슈 관리 (기획, 마케팅 등과 협의 시에는 트렐로(Trello)로 관리)</li>
                                            </ul>
                                        </li>
                                        <li className="experience-list__txt experience-box">
                                            <span className="experience-box__head">앱 내의 웹페이지 서비스 개발</span>
                                            <ul>
                                                <li>- 개발팀 협의로 앱 내에 웹페이지 개발이 필요한 부분은 웹 포지션으로 개발 (개발 변경이 잦은 서비스 페이지 등)</li>
                                            </ul>
                                        </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li className="experience-list__date">2016.9 ~ 2018.5, 1년 9개월</li>
                                        <li className="experience-list__item-box experience-box">
                                            <ul className="experience-box__item-list">
                                                <li>HTML5</li>
                                                <li>CSS3</li>
                                        ...
                                        <li className="experience-list__txt experience-box">
                                            ...
                                            <ul>
                                                <li>- 입사 후 개발 시작 단계 : 서버 세팅만 되어있는 상태에서 처음부터 개발을 시작하는 단계</li>
                                                <li>- 웹 작업 비율(%) = 웹 디자인 작업 70% + 퍼블리싱 30%</li>
                                            </ul>
                                        </li>
                                        <li className="experience-list__inner-box">웹디자인(UI, UX)에 대한 감각을 키웠습니다. 서버 개발자와 협업하면서 작업관리 시스템의 필요성을 느꼈습니다. (겨우 두 명이지만 같이 코드를 공유하면서 업데이트되어야 할 코드가 지워지는 등 코드 관리 문제가 있었습니다.) 웹 퍼블리셔로 일하면서 개발에 대한 갈증이 더욱 생겼습니다.</li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        <li className="experience-list__date">2011.3 ~ 2015.10, 4년 8개월 </li>
                                        <li className="experience-list__item-box experience-box">
                                            <ul className="experience-box__item-list">
                                                <li>AutoCAD</li>
                                                <li>SketchUp</li>
                                        ...
                                        <li className="experience-list__inner-box">세상을 보는 시야가 넓어졌습니다. 길을 걷다가도 바닥 포장재와 패턴, 배수 형태, 어떤 조경수를 심었는지, 옥외 계단 구조물 등 설계가 머릿 속에 대략 그려집니다. 공간과 구조물, 시설물의 디테일을 보면 그 공간에 얼마나 노력이 들어갔는지 알 수 있습니다.</li>
                                    </ul>
                                </li>
                            </ul>
                        </article>
                        ...
                        <article className="content-box content-box-qna">
                            ...
                            <dl className="table-box">
                                ...
                                <dd className="table-box__a" value="a-1">
                                    웹디자인 경험이 있어서 기획, 디자인팀과 업무 커뮤니케이션이 원만합니다. 필요하면 간단한 디자인은 제가 할 수도 있습니다.
                                    <br/>웹페이지 퍼블리싱 작업의 구현 속도가 빠릅니다.
                                    <br/>일에 대한 책임감이 있습니다. 당연한 말이지만, 정해진 시간 내에 맡은 업무를 잘 수행하려고 하고, 갑작스런 버그나 이슈가 생기면 적극적으로 나섭니다.
                                </dd>
                                ...
                                <dd className="table-box__a" value="a-5">
                                    일은 삶에서 많은 비중을 차지하기 때문에, 일 하는 것이 곧 삶이라고 여깁니다. 그리고 일은 사회에서 '나'의 가치를 실현할 수 있는 좋은 도구라고 생각합니다.
                                    <br/>개인 취향이지만, 몰입해서 일 하는 것을 좋아하여 음악도 잘 듣지 않습니다. 그리고 일을 잘 해나감으로써 저 스스로도 같이 잘 성장해나가고 싶습니다.
                                    <br/>그래서 저는 제가 좀 더 잘 할 수 있는, 재미있는, 좋은 서비스를 가진, 발전 가능성이 있는 일을 하고 싶습니다.
                                </dd>
                                ...
                                <dd className="table-box__a" value="a-9">
                                    ...
                                    <br/>웹 사이트는 친숙하고 매일 접합니다. 그래서 평소에도 눈길을 끄는 웹사이트를 발견하면 '즐겨찾기'에 추가하곤 했습니다. 웹사이트를 만드는 것이 재미있어 보여서 시작하게 되었습니다.
                                </dd>
                                <dt className="table-box__q" value="q-10">퍼블리셔에서 프론트엔드 개발자가 된 계기는 무엇인가요?</dt>
                                <dd className="table-box__a" value="a-10">
                                    웹 퍼블리셔로 웹을 다루기 시작하다가 디자인 작업보다 프론트단 개발하는 것에 욕심이 생겼습니다. 그 당시에 웹 디자인, HTML 마크업, CSS까지는 완전히 저의 담당이었고, JS 동적인 부분은 데이터 연결 전까지 할 수 있는 작업을 모두 해서 넘기는 식이었습니다. 그러다가 자바스크립트 영역을 더 많이, 잘 다루고 싶어졌고, 개발 관련하여 여러 스터디(프론트 백엔드 스터디 등)를 다니다가 좋은 인연을 만나서 스타트업 개발팀에서 프론트엔드 개발자로 일을 하게 되었습니다
                                </dd>
