        ...
        this.state = {
            ...
            work: [
                {
                    ...
                    workDetail: [
                        {
                            ...
                            content: [
                                "회원가입, 로그인, 게시물 작성, 상세페이지, 서비스 목록, 검색 등 40여 페이지를 개발. 기획(OneNote)/디자인(Zeplin) 일정 딜레이로 인해, 프론트엔드 개발이 동시에 진행. React, TypeScript 적용.",
                            ],
                        },
                        {
                            head: "인테리어 플랫폼 데모 웹페이지 개발",
                            content: ["AI 엔진이 들어간 페이지를 제외한 나머지는 더미 데이터로 페이지를 구성. PPT로 만든 기획/디자인을 토대로 개발 진행."],
                        },
                        {
                            head: "쇼핑몰 상세페이지 에디터 툴(사맛디 에디터) 웹 프론트 개발",
                            content: [
                                "이미지만 업로드하면, 쇼핑몰 상세페이지를 자동으로 만들어주는 웹페이지 개발. 사맛디 AI 엔진을 통해 이미지를 분석하여 자동으로 레이아웃 배치 및 크롭을 함. 프론트엔드 단에서는 이미지를 많이 다뤘기 때문에 이미지 경량화에 신경을 많이 썼고, 이미지 커스텀 단계에서 캔버스 컨트롤하는 기능을 주로 다룸. 데모 이후 커스텀 단계에서 개발 중단.",
                            ],
                        },
                        {
                    ...
                    effect: "[쇼핑몰 상세페이지 에디터 툴] 개발을 위한 채용으로 이 회사에 입사하게 되었습니다. fabricjs(오픈소스)를 이용하였고, 이 경험이 캔버스를 다루는 데 많은 도움이 되었습니다. Docker와 Gitlab CI/CD에 대하여 공부할 수 있는 시간을 가졌습니다. 웹 서버 구축에 대한 개념을 알아갈 수 있었습니다. [인테리어 플랫폼 웹페이지 개발] 프로젝트에서 TypeScript를 처음 사용하였는데, 데이터 타입을 정의하면서 가독성이 좋고, 오류가 생길 수 있는 여지가 줄어들어서 필수로 사용해야 할 도구임을 알게 되었습니다.",
                },
                {
                    company: "(주)인라이플",
                    ...
                    effect: "연구 개발한 결과물에 대하여 의도한 방향대로 시연하기 위한 프론트단 작업을 주로 하였습니다. 연구 팀원들과 데이터를 구축하고, 연구에 대한 실험하는 과정을 함께 하면서 모든 것이 새롭고 좋은 경험이었습니다. 가상환경에 대한 필요성을 알게 되었고, 플라스크(flask)를 통해서 백엔드 단을 다루었습니다.",
                },
                {
                    company: "(주)휴마트컴퍼니",
                    position: "개발팀 - 프론트엔드 개발자",
            ...
            SideProject: [
                ...
                },
                {
                    ...
                    desc: "스터디 프로젝트 (도서 관리 시스템 만들기) : 개발 스터디에서 같이 프로젝트를 시작해서 어떠한 성과를 만들어보고 싶었습니다. 어떤 니즈가 있을까 얘기하다가 도서 관리 시스템을 만들어보자는 의견이 나와서 시작하게 되었습니다. 제가 디자인을 할 줄 알아서 제가 디자인을 담당했고 모두의 의견을 받아서 디자인 진행을 하였습니다. 프론트 개발은 다른 개발자와 같이 하기로 했습니다. 비록 개발 진행 중에 멈춰버렸지만, 의미 있는 작업이었습니다.",
                },
                {
