...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var _loop = function _loop(i) {
    document.getElementsByClassName('table-box__q')[i].addEventListener('click', function () {
      // 모두 닫기
      for (var j = 0; j < document.getElementsByClassName('table-box__q').length; j += 1) {
        document.querySelectorAll(".table-box__q")[j].classList.remove('is-show');
      }

      var targetNum = 'a-' + document.getElementsByClassName('table-box__q')[i].getAttribute('value').split('q-')[1];
      console.log("targetNum : ".concat(targetNum));
      console.log(document.querySelectorAll(".table-box__a[value='".concat(targetNum, "']"))[0]);

      if (document.querySelectorAll(".table-box__a[value='".concat(targetNum, "']"))[0].classList.contains('is-show')) {
        // document.getElementsByClassName('table-box__q')[i].classList.remove('is-show');
        return document.querySelectorAll(".table-box__a[value='".concat(targetNum, "']"))[0].classList.remove('is-show'); // return document.querySelectorAll(`.table-box__a[value='${targetNum}']`)[0].style.display = "block";
      } // document.getElementsByClassName('table-box__q')[i].classList.add('is-show');


      return document.querySelectorAll(".table-box__a[value='".concat(targetNum, "']"))[0].classList.add('is-show'); // return document.querySelectorAll(`.table-box__a[value='${targetNum}']`)[0].style.display = "none";
    });
  };

  for (var i = 0; i < document.getElementsByClassName('table-box__q').length; i += 1) {
    _loop(i);
  }

  var _loop2 = function _loop2(_i) {
    document.querySelectorAll('.side-project-list > li')[_i].addEventListener('click', function () {
      ...
      document.querySelectorAll('.side-project-list > li')[_i].classList.add('is-active');
    });
  };

  for (var _i = 0; _i < document.querySelectorAll('.side-project-list > li').length; _i += 1) {
    _loop2(_i);
  }
...
/******/ });
//# sourceMappingURL=index.bundle.js.map?166c5e81584c7f695d9d